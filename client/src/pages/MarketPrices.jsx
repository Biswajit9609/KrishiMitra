              ...
              <div className="flex flex-col md:flex-row gap-4">
                ...
                <Select value={selectedCrop} onValueChange={setSelectedCrop}>
                  <SelectTrigger className="w-full md:w-48">
                    <SelectValue placeholder={t('searchCrops')} />
                  </SelectTrigger>
                  <SelectContent>
                    {crops.map((crop) => (
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center space-x-2">
                ...
                <span>{t('marketAdvisory')}</span>
              </CardTitle>
              <CardDescription>{t('bestSellingRecommendations')}</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                  <h4 className="font-medium text-green-900 mb-2">{t('bestTimeToSell')}</h4>
                  <p className="text-sm text-green-800 mb-3">
                    {t('wheatPricesTrending')}
                  </p>
                  <div className="text-xs text-green-700">
                    {t('expectedPriceRange')}
                  </div>
                </div>
                
                <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  <h4 className="font-medium text-blue-900 mb-2">{t('marketInsights')}</h4>
        ...
        >
          <Card>
            <CardHeader>
              ...
              <CardDescription>{t('sevenDayPriceMovement')}</CardDescription>
            </CardHeader>
            <CardContent>
